...
//register the widget
add_action( 'widgets_init', 'wpdemos_widget' );

if ( ! function_exists( 'wpdmeos_widget' ) ) {

	/** Initializes themes widgets.*/
	function wpdemos_widget() {
		register_sidebar(
			array(
				'name'          => __( 'Footer Column One', 'wpdemos_widget' ),
				'id'            => 'footer-col-one',
				'description'   => __( 'Footer column one widget area', 'wpdemos_widget' ),
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer Column Two', 'wpdemos_widget' ),
				'id'            => 'footer-col-two',
				'description'   => __( 'Footer column two widget area', 'wpdemos_widget' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'wpdemos_widget' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right Sidebar', 'wpdemos_widget' ),
